...
libraryDependencies ++= Seq(
  ...
  "de.dnpm.dip"            %% "service-base"                % "1.5.0",
  "de.dnpm.dip"            %% "mtb-validation-service-api"  % "1.1.10",
  "de.dnpm.dip"            %% "mtb-validation-service-impl" % "1.1.10",
  "de.dnpm.dip"            %% "mtb-query-service-api"       % "1.1.5",
  "de.dnpm.dip"            %% "mtb-query-service-impl"      % "1.1.5",
  "de.dnpm.dip"            %% "rd-validation-service-api"   % "1.1.10",
  "de.dnpm.dip"            %% "rd-validation-service-impl"  % "1.1.10",
