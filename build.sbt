...
libraryDependencies ++= Seq(
  ...
  "de.dnpm.dip"            %% "mtb-validation-service-api"  % "1.0.1",
  "de.dnpm.dip"            %% "mtb-validation-service-impl" % "1.0.1",
  "de.dnpm.dip"            %% "mtb-query-service-api"       % "1.0.0",
  "de.dnpm.dip"            %% "mtb-query-service-impl"      % "1.0.0",
  "de.dnpm.dip"            %% "rd-validation-service-api"   % "1.0.1",
  "de.dnpm.dip"            %% "rd-validation-service-impl"  % "1.0.1",
