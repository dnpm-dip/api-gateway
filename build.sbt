...
ThisBuild / version      := envOrElse("VERSION","1.2.2")
...
libraryDependencies ++= Seq(
  ...
  "de.dnpm.dip"            %% "mtb-validation-service-api"  % "1.1.5",
  "de.dnpm.dip"            %% "mtb-validation-service-impl" % "1.1.5",
  "de.dnpm.dip"            %% "mtb-query-service-api"       % "1.1.2",
  "de.dnpm.dip"            %% "mtb-query-service-impl"      % "1.1.2",
  "de.dnpm.dip"            %% "rd-validation-service-api"   % "1.1.6",
  "de.dnpm.dip"            %% "rd-validation-service-impl"  % "1.1.6",
