...
The URI paths below assume that your backend is exposed via the reverse proxy as configured in the deployment setup,
...
> :warning: **IMPORTANT NOTE**: Bear in mind that these JSON schemas for MTB and RD Patient Records are _provisional_, given that some adaptations
...
> :warning: **IMPORTANT NOTE for MTB uploads (data uploads, JSON schemas)**:
>
